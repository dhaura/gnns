...
def convert_pubmed_to_txt(
  node_data_file='./pubmed-diabetes/data/Pubmed-Diabetes.NODE.paper.tab',
  edge_list_file='./pubmed-diabetes/data/Pubmed-Diabetes.DIRECTED.cites.tab',
  output_dir='./pubmed-diabetes/data'
):
