...
plot_accuracies('../output/gsv1-max-val-accuracies.csv', '../output/plots', 'gsv1-max-val-accuracies.png', 'GraphSAGE V1 (Max) Training')
plot_accuracies('../output/gsv2-mean-val-accuracies.csv', '../output/plots', 'gsv2-mean-val-accuracies.png', 'GraphSAGE V2 (Mean) Training')
plot_accuracies('../output/gsv2-sum-val-accuracies.csv', '../output/plots', 'gsv2-sum-val-accuracies.png', 'GraphSAGE V2 (Sum) Training')
plot_accuracies('../output/gsv2-max-val-accuracies.csv', '../output/plots', 'gsv2-max-val-accuracies.png', 'GraphSAGE V2 (Max) Training')
