...
# '''
#   Train the GCN V3 model with bias on the cora dataset using a random data split.
# '''
# # Get split masks.
# train_mask, test_mask, val_mask = get_data_split_masks(features.shape[0], train_ratio=0.6, test_ratio=0.2, shuffle=True)
...
# with open(output_file_path, 'a') as f:
#     f.write(f'GCN V3 (B),cora,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
