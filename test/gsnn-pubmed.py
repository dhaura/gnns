...
#     f.write(f'graphSAGEv1-mean,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
# with open(output_file_path, 'a') as f:
#     f.write(f'graphSAGEv1-sum,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
# with open(output_file_path, 'a') as f:
#     f.write(f'graphSAGEv1-max,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
# with open(output_file_path, 'a') as f:
#     f.write(f'graphSAGEv2-mean,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
# with open(output_file_path, 'a') as f:
#     f.write(f'graphSAGEv12sum,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
# with open(output_file_path, 'a') as f:
#     f.write(f'graphSAGEv2-max,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv3-mean,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv3-sum,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv3-max,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv4-mean,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv4-sum,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
...
with open(output_file_path, 'a') as f:
    f.write(f'graphSAGEv4-max,pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')
