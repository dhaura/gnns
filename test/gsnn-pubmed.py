...
with open(output_file_path, 'a') as f:
    f.write(f'GS V3 (Mean),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv3-mean-val-accuracies.csv')
...
with open(output_file_path, 'a') as f:
    f.write(f'GS V3 (Sum),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv3-sum-val-accuracies.csv')
...
with open(output_file_path, 'a') as f:
    f.write(f'GS V3 (Max),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv3-max-val-accuracies.csv')
...
with open(output_file_path, 'a') as f:
    f.write(f'GS V4 (Mean),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv4-mean-val-accuracies.csv')
...
with open(output_file_path, 'a') as f:
    f.write(f'GS V4 (Sum),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv4-sum-val-accuracies.csv')
...
with open(output_file_path, 'a') as f:
    f.write(f'GS V4 (Max),pubmed,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('pubmed', val_accuracies, output_dir + '/gsv4-max-val-accuracies.csv')
