...
'''
  Train the GCN V1 model on the cora dataset.
'''
...
'''
  Train the GCN V3 model on the cora dataset without using iSpLib patch.
'''
...
with open(gcn_cpu_results_file_path, 'a') as f:
    f.write(f'GCN V3,cora,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

'''
  Train the GCN V3 model on the cora dataset using iSpLib patch.
'''
...
with open(gcn_cpu_results_file_path, 'a') as f:
    f.write(f'GCN V3 (iSpLib),cora,{average_accuracy},{average_elapsed_time},{average_num_epochs_to_converge}\n')

write_accuracies_to_csv('cora', val_accuracies, output_dir + '/gcnv3-bias-val-accuracies.csv')
